...
- Обязательно поприветствуйте его вежливо и представьтесь как менеджер Caravan of Knowledge
- Предложите свою помощь и укажите, по каким вопросам можете проконсультировать
- Будьте дружелюбны и создайте хорошее первое впечатление"""
        else:
            greeting_instruction = """
